...
const projects = [
  {
    ...
    description:
      "Capturing timeless moments of love, joy, and celebration on your special day.",
  },
  {
    img: project2,
    ...
    description:
      "Beautifully framed transitions celebrating cultural milestones and traditions.",
  },
  {
    img: project3,
    ...
    description:
      "Cherishing the glow of motherhood with soft and elegant maternity portraits.",
  },
  {
    img: project4,
    ...
    slug: "birthday-shoot",
    description:
      "Colorful and candid memories to celebrate joyful birthdays at any age.",
  },
  {
    img: project5,
    ...
    description:
      "Elegant bridal portraits capturing grace, beauty, and emotion.",
  },
  {
    img: project6,
    ...
    description:
      "High-quality product shots tailored for advertising and branding.",
  },
  {
    img: project7,
    ...
    description:
      "Capturing sacred moments and spiritual ambiance in temple surroundings.",
  },
  {
    img: project8,
    title: "Album Design",
    slug: "album-design",
    description:
      "Customized storytelling through beautifully crafted photo albums.",
  },
  {
    img: project9,
    title: "Video Edits",
    slug: "video-edits",
    description:
      "Creative video edits that bring emotions and stories to life.",
  },
];
              ...
              <div>
                {project.slug === "album-design" ? (
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    {/* External Facebook video link */}
                    <a
                      href="https://www.facebook.com/share/r/1Ba4bb5FzJ/?mibextid=wwXIfr"
                      target="_blank"
